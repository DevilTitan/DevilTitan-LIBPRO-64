...
#include "../../../DevilTitan-LIBPRO-64/LIBPRO.h"
...
const QMetaObject LIBPRO::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_LIBPRO.data,
      qt_meta_data_LIBPRO,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LIBPRO::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::LIBPRO"))
        return static_cast< Ui::LIBPRO*>(const_cast< LIBPRO*>(this));
